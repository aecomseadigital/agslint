...
- `.github/workflows/` contains CI and release automation for the external GitHub remote
...
- the external GitHub remote is set up for automated release PRs and tagged GitHub Releases from `main`
- the internal `aecom` remote can still use the documented local fallback flow in [RELEASING.md](./RELEASING.md)
...
- Packaging and changelog automation assume the external GitHub mirror is available for workflow execution
